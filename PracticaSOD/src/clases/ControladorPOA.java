 ...
 implements clases.ControladorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("crearRSA", new java.lang.Integer (11));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 8:  // clases/Controlador/crearMD5
       {
         ...
         int dic = in.read_ulong ();
         clases.Trabajo $result = null;
         $result = this.crearMD5 (cadena, tam_maximo, dic);
         out = $rh.createReply();
         clases.TrabajoHelper.write (out, $result);
         break;
       }
       ...
       case 9:  // clases/Controlador/crearSHA
       {
         ...
         int dic = in.read_ulong ();
         clases.Trabajo $result = null;
         $result = this.crearSHA (cadena, tam_maximo, dic);
         out = $rh.createReply();
         clases.TrabajoHelper.write (out, $result);
         break;
       }
       ...
       case 10:  // clases/Controlador/crearRed
       {
         ...
         int dic = in.read_ulong ();
         clases.Trabajo $result = null;
         $result = this.crearRed (cadena, puerto, usuario, tam_maximo, dic);
         out = $rh.createReply();
         clases.TrabajoHelper.write (out, $result);
         break;
       }

       case 11:  // clases/Controlador/crearRSA
       {
         String cadena1 = in.read_string ();
         String cadena2 = in.read_string ();
         clases.Trabajo $result = null;
         $result = this.crearRSA (cadena1, cadena2);
         out = $rh.createReply();
         clases.TrabajoHelper.write (out, $result);
         break;
       }
