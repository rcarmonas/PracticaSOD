 ...
 implements clases.ControladorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("setDivision", new java.lang.Integer (5));
    _methods.put ("dividirTrabajo", new java.lang.Integer (6));
    _methods.put ("crearMD5", new java.lang.Integer (7));
    _methods.put ("crearSHA", new java.lang.Integer (8));
    _methods.put ("crearRed", new java.lang.Integer (9));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // clases/Controlador/setDivision
       {
       ...
       case 6:  // clases/Controlador/dividirTrabajo
       {
         clases.Trabajo t = clases.TrabajoHelper.read (in);
       ...
       case 7:  // clases/Controlador/crearMD5
       {
       ...
       case 8:  // clases/Controlador/crearSHA
       {
         String cadena = in.read_string ();
         int tam_maximo = in.read_ulong ();
         clases.Trabajo $result = null;
       ...
       case 9:  // clases/Controlador/crearRed
       {
         String cadena = in.read_string ();
