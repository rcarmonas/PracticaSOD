 ...
 implements clases.ControladorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getDivision", new java.lang.Integer (1));
    _methods.put ("setDivision", new java.lang.Integer (2));
    _methods.put ("dividirTrabajo", new java.lang.Integer (3));
    _methods.put ("crearMD5", new java.lang.Integer (4));
    _methods.put ("crearSHA", new java.lang.Integer (5));
    _methods.put ("crearRed", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // clases/Controlador/getDivision
       {
       ...
       case 2:  // clases/Controlador/setDivision
       {
       ...
       case 3:  // clases/Controlador/dividirTrabajo
       {
       ...
       case 4:  // clases/Controlador/crearMD5
       {
       ...
       case 5:  // clases/Controlador/crearSHA
       {
         String cadena = in.read_string ();
         int tam_maximo = in.read_ulong ();
         boolean $result = false;
       ...
       case 6:  // clases/Controlador/crearRed
       {
         String cadena = in.read_string ();
