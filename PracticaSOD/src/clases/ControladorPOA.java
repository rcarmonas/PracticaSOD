 ...
 implements clases.ControladorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("finTrabajo", new java.lang.Integer (0));
    _methods.put ("getTrabajo", new java.lang.Integer (1));
    _methods.put ("setTrabajo", new java.lang.Integer (2));
    _methods.put ("crearMD5", new java.lang.Integer (3));
    _methods.put ("crearSHA", new java.lang.Integer (4));
    _methods.put ("crearRed", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // clases/Controlador/finTrabajo
       {
         int id = in.read_ulong ();
         String trabajo = in.read_string ();
         this.finTrabajo (id, trabajo);
         out = $rh.createReply();
         break;
       }

       case 1:  // clases/Controlador/getTrabajo
       {
         clases.Division $result = null;
         $result = this.getTrabajo ();
         out = $rh.createReply();
         clases.DivisionHelper.write (out, $result);
         break;
       }

       case 2:  // clases/Controlador/setTrabajo
       {
         clases.Division t = clases.DivisionHelper.read (in);
         boolean $result = false;
         $result = this.setTrabajo (t);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 3:  // clases/Controlador/crearMD5
       {
       ...
       case 4:  // clases/Controlador/crearSHA
       {
         String cadena = in.read_string ();
         int tam_maximo = in.read_ulong ();
         boolean $result = false;
       ...
       case 5:  // clases/Controlador/crearRed
       {
         String cadena = in.read_string ();
